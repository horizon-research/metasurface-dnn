...
def get_CIFAR100_color(num_training=49000, num_validation=1000, num_test=10000,
                     subtract_mean=False, channels_first=False):
    data = get_CIFAR100_data(num_training, num_validation, num_test, subtract_mean, channels_first)
